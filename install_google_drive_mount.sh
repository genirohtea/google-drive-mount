...
This script runs the Ansible playbook for mounting Google Drive
...
ansible-playbook main.yml ${ssh_pass:-} ${verbosity:-} ${tags} --extra-vars '{}' --limit "${host}" -i inventory/hosts.yaml
